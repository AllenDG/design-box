  ...
  return (
    <div className="mt-28 grid gap-4 md:grid-cols-2 md:grid-rows-2">
      ...
      <div className="mb-20 text-left">
        ...
        <button className="rounded-lg border border-secondary-100 px-4 py-2 text-sm font-bold text-secondary-600 transition duration-300 hover:bg-secondary-600 hover:text-white dark:border-white dark:text-white dark:hover:bg-secondary-800 dark:hover:text-secondary-100">
          Let&apos;s Work Together
        </button>
      </div>
